            ...
            <tbody id="myTable">
                <c:forEach var="debt" items="${list}">
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a class="btn btn-outline-info" href="Debts?service=getDebtById&debt_id=${debt.getId()}">
                                    <i class="fas fa-info-circle"></i>
                                </a>
                                <button type="button" class="btn btn-outline-warning" data-toggle="modal" data-target="#editDebtModal${debt.getId()}">
