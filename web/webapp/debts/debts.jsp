        ...
        <div class="page-wrapper">
            ...
            <div class="top-bar">
                ...
                <form action="Debts" method="POST" class="custom-search-form">
                    ...
                    <div class="search-box">
                        <input type="text" id="myInput" class="input-box" list="browsers" name="browser" id="browser" placeholder="Search for a debts..." autocomplete="off">
            ...
            <aside class="side-bar">
                ...
                <ul class="navbar-links navbar-links-1">
                    ...
                    <li>
                        <a href="/ISP392/Products?service=products">
                            <span class="nav-icon">
                    ...
                    <li class="active">
                        <a href="/ISP392/Debts?service=debts">
                            <span class="nav-icon">
