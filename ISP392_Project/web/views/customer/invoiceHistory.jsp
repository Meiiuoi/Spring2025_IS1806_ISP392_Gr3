<%-- 
    Document   : invoiceHistory
    Created on : Mar 30, 2025, 12:40:30 AM
    Author     : THC
--%>
...
<html>
    ...
    <body>
        ...
        <div class="page-wrapper">
                ...
                <div class="panel-bar1">
                    ...
                    <div class="invoice-filter-container">
                        <div class="form-wrapper">
                            <form action="Invoices" method="POST" class="invoice-filter-form">
                                <input type="hidden" name="service" value="invoiceInCustomers" />
                                ...
                                <div class="form-group button-group">
                                    ...
                                    <a href="Invoices?service=invoiceInCustomers&customer_id=${listName.id}" class="btn btn-secondary">Reset</a>
                                </div>
                            </form>
                        </div>
                    </div>

                    <h4 class="mt-4">Invoice History</h4>
                                ...
                                <c:when test="${not empty orderList}">
                                    <c:forEach var="order" items="${orderList}">
                                        <tr>
                                            ...
                                            <td><fmt:formatNumber value="${orderDetail.price}" pattern="###,##0" /></td>
                                        </tr>
                                    </c:forEach>
                                </c:when>
                                <c:otherwise>
                    ...
                    <form action="Invoices" method="POST" style="display: inline;">
                        ...
                        <span>of ${totalInvoices} invoices</span>
                    </form>
            ...
            <div class="modal fade" id="invoiceDetailModal" tabindex="-1" role="dialog" aria-labelledby="invoiceDetailLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content shadow-lg">
                        <div class="modal-header bg-primary text-white">
                            <h5 class="modal-title">
                                <i class="fas fa-file-invoice-dollar"></i> Invoice Details - <strong id="modalInvoiceId"></strong>
                            </h5>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="modalInvoiceAmount" type="text" class="form-control bg-light border-0" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label class="text-muted"><strong>Created At:</strong></label>
                                        <input id="modalInvoiceCreatedAt" type="text" class="form-control bg-light border-0" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea id="modalInvoiceDescription" class="form-control bg-light border-0" rows="3" readonly></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class="text-muted"><strong>Status:</strong></label>
                                        <input id="modalInvoiceStatus" type="text" class="form-control bg-light border-0" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-center mt-3">
                                ...
                                <div class="border p-2 rounded bg-light">
                                    <img id="modalInvoiceImage" class="myImg img-fluid rounded shadow" style="max-height: 300px; object-fit: cover;" alt="Invoice evidence">
                                </div>
                            </div>
                        </div>
